...
export function JoinButton({ slug, platform = "other" }: JoinButtonProps) {
  ...
  return (
    <div className="space-y-3">
      {error && (
        <div
          className={`p-3 bg-[#FFEBEE] dark:bg-[#3D1A1A] text-[#C62828] dark:text-[#EF5350] text-sm text-center ${
      ...
      <button
        ...
        disabled={isJoining}
        className={`
          w-full bg-[#00A884] hover:bg-[#00997A] text-white
